					...
					<div class="header_tab">
						<ul>
							...
							<li><span class="header_hi">Hi,</span><span
								class="header_usename">fkk</span>！</li>
					...
					<ul id="showMainNav" class="fix">
						...
						<li class="navContent">
							<a href="#" class="showNav" id="department" data-name="main_iframe"
							   onclick="Common.switchNavigation(this);"
							   data-url="${pageContext.request.contextPath}/student/manage.do">学生管理</a>
						</li>
						<li class="navContent">
							<a href="#" class="showNav" id="employee" data-name="main_iframe"
							onclick="Common.switchNavigation(this);"
							data-url="${pageContext.request.contextPath}/employee/manage.do">课程管理</a>
						</li>
						<li class="navContent">
							<a href="#" class="showNav" id="salary" data-name="main_iframe"
							   onclick="Common.switchNavigation(this);"
							   data-url="${pageContext.request.contextPath}/salary/manage.do">成绩管理</a>
						</li>
					</ul>
				</nav>
			</div>
